...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  gameApi.getIndex().then(gameUi.getIndexSucess).catch(gameUi.getIndexFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var clearBoard = function clearBoard(event) {
	  ...
	  $('#8').on('click', onSelectCell).text('+');
	  var data = getFormFields(event.target);
	  gameApi.getIndex(data).then(gameUi.clearBoardSuccess).catch(gameUi.clearBoardFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(data) {
	  return $.ajax({
	    ...
	    data: { 'game': { 'cell': { 'index': store.game.cell.index, 'value': store.game.cell.value
	        }
	      },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var clearBoardSuccess = function clearBoardSuccess(data) {
	  store.moves = 0;
	  store.currentPlayer = 'X';
	  store.game = {};
	  store.game.value = '';
	  store.game.over = false;
	  gameApi.createGame(data).then(getIndexSuccess).catch(getIndexFailure);
	};

	var clearBoardFailure = function clearBoardFailure() {};
	...
	var updateGameSuccess = function updateGameSuccess(data) {
	  ...
	  if (store.game.over === true) {
	    ...
	    store.gamesPlayed++;
	    $('#gamesPlayed').text('Games Played: ' + store.gamesPlayed);
	    gameApi.updateGame().then(getIndexSuccess).catch(getIndexFailure);
	  }
	};
	...
	module.exports = {
	  ...
	  clearBoardSuccess: clearBoardSuccess,
	  clearBoardFailure: clearBoardFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var whoWins = function whoWins() {
	  // rows
	  if (store.game.cells[0] === 'X' && store.game.cells[1] === 'X' && store.game.cells[2] === 'X' || store.game.cells[3] === 'X' && store.game.cells[4] === 'X' && store.game.cells[5] === 'X' || store.game.cells[6] === 'X' && store.game.cells[7] === 'X' && store.game.cells[8] === 'X' ||
	  // columns
	  store.game.cells[0] === 'X' && store.game.cells[3] === 'X' && store.game.cells[6] === 'X' || store.game.cells[1] === 'X' && store.game.cells[4] === 'X' && store.game.cells[7] === 'X' || store.game.cells[2] === 'X' && store.game.cells[5] === 'X' && store.game.cells[8] === 'X' ||
	  // diagonal
	  store.game.cells[0] === 'X' && store.game.cells[4] === 'X' && store.game.cells[8] === 'X' || store.game.cells[2] === 'X' && store.game.cells[4] === 'X' && store.game.cells[6] === 'X') {
	    store.winner = 'Player X is the winner!';
	    store.gamesWon++;
	    store.game.over = true;
	    return store.game.over;
	  } else if (store.game.cells[0] === 'O' && store.game.cells[1] === 'O' && store.game.cells[2] === 'O' || store.game.cells[3] === 'O' && store.game.cells[4] === 'O' && store.game.cells[5] === 'O' || store.game.cells[6] === 'O' && store.game.cells[7] === 'O' && store.game.cells[8] === 'O' ||
	  // columns
	  store.game.cells[0] === 'O' && store.game.cells[3] === 'O' && store.game.cells[6] === 'O' || store.game.cells[1] === 'O' && store.game.cells[4] === 'O' && store.game.cells[7] === 'O' || store.game.cells[2] === 'O' && store.game.cells[5] === 'O' && store.game.cells[8] === 'O' ||
	  // diagonal
	  store.game.cells[0] === 'O' && store.game.cells[4] === 'O' && store.game.cells[8] === 'O' || store.game.cells[2] === 'O' && store.game.cells[4] === 'O' && store.game.cells[6] === 'O') {
